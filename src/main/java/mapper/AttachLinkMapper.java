...
public interface AttachLinkMapper {
    ...
    List<AttachLink> findByTarget(String targetType, Long targetId);
    void deleteByTarget(String targetType, Long targetId);	// 게시글 삭제시 attachLink 삭제
    Long countLinkAttachId (Long attachId);	// attach도 삭제하기 위해 연결된 attachId 개수 조회
}
