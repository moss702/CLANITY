			...
			<div class="row text-muted small">
				...
				<div class="col-md-4 mb-4">
					...
					<ul class="list-unstyled mt-3">
						...
						<li><a href="${cp}/faq"
							class="text-decoration-none text-dark">자주 묻는 질문</a></li>
						<li><a href="${cp}/qna"
							class="text-decoration-none text-dark">고객센터 문의하기</a></li>
					</ul>
				</div>
				...
				<div class="col-md-4 mb-4">
					...
					<ul class="list-unstyled mt-3">
						<li><a href="#" class="text-decoration-none text-dark"><i
								class="fa-brands fa-instagram"></i></a></li>
						<li><a href="#" class="text-decoration-none text-dark">네이버
								블로그</a></li>
					</ul>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="d-flex gap-2">
						<a href="${cp}/provision/termsOfUse"
							class="text-decoration-none text-dark">이용약관</a> | <a
							href="${cp}/provision/termsPersonal"
							class="text-decoration-none text-dark">개인정보처리방침</a> | <a
							href="${cp}/provision/information"
							class="text-decoration-none text-dark">사업자정보확인</a>
					</div>
				</div>
